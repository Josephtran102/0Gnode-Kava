...
Replace `your_node_name` and `wallet_name` If you need to change the port, please also proceed with the port change
...
You can see your node's latsest\_block\_height like below (Or you can check `catching_up` is `false`) If the block height is set, you can create validator.
...
_Important write this mnemonic phrase in a safe place_
...
\*_Important keep your private key carefully to import Metamask_
